...
public class ResUtil {
    ...
    public static byte[] decodeAssetResData(Context context,
        ...
        try {
            ...
            Log.e(TAG, "decodeAssetResData not found resName:" + resName + "errorMsg:" + e.getLocalizedMessage());
            return null;
        } catch (OutOfMemoryError e) {
            Log.e(TAG, "decodeAssetResData OutOfMemoryError resName:" + resName + "errorMsg:" + e.getLocalizedMessage());
            return null;
        } catch (Exception e) {
            Log.e(TAG, "decodeAssetResData exception resName:" + resName + "errorMsg:" + e.getLocalizedMessage());
            return null;
        } finally {
            try {
                if (bout != null) {
    ...
    public static BitmapFactory.Options getImageWidthHeight(int resId) {
        ...
        Bitmap bitmap = BitmapFactory.decodeResource(CommonAppication.Companion.getApplication()
                .getResources(), resId, options); // 此时返回的bitmap为null
